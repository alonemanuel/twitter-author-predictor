...
class Preprocessor:
    ...
    def preprocess(self):
		...
		'''
        self.split_tweets_labels()
        self.extract_features()

    def split_tweets_labels(self):
        '''
    ...
    def extract_features(self):
        '''
		Extracts features out of the training data.
		'''
        if IS_TFIDF:
    ...
    def count_vectorize(self, min_ngram=1, max_ngram=3, min_df=1, max_df=1,
                        max_feat=1000):
    ...
    def extract_features(self, nbag=3, min=0):
